        ...
        <div class="header">
            <div class="header-left">
                <a href="index-2.html" class="logo">
                    <img src="{{asset('img/logo.png')}}" width="35" height="35" alt=""> <span>Preclinic</span>
                </a>
            </div>
                            ...
                            <ul class="notification-list">
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
                                            <span class="avatar">
                                                <img alt="John Doe" src="{{asset('img/user.jpg')}}" class="img-fluid">
                                            </span>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fa fa-bug"></i> <span> Pathogens </span> <span
                                    class="menu-arrow"></span></a>
                            <ul {{--  style="display: none;"  --}}>
                                <li><a href="/pathogens">View All</a></li>
                                <li><a href="/pathogens/create">Create</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
                            <a href="#"><i class="fa fa-book"></i> <span> Guidelines </span> <span
                                    class="menu-arrow"></span></a>
                            <ul {{--  style="display: none;"  --}}>
                                <li><a href="/guidelines">View All</a></li>
                                <li><a href="/guidelines/create">Create</a></li>
                            </ul>
                        </li>
